...
def main():
    ...
    # pgie.set_property('config-file-path', "/opt/nvidia/deepstream/deepstream-5.1-5.1/samples/configs/deepstream-app/config_infer_primary.txt")

    # tracker.set_property('ll-lib-file', '/opt/nvidia/deepstream/deepstream-5.1-5.1/lib/libnvds_nvdcf.so')
    # tracker.set_property('gpu-id', 0)
    # tracker.set_property('enable-past-frame', 1)
    # tracker.set_property('enable-batch-process', 1)
    # tracker.set_property('ll-config-file', '/opt/nvidia/deepstream/deepstream-5.1-5.1/samples/configs/deepstream-app/tracker_config.yml')
